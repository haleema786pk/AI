...
if __name__ == '__main__':
    ...
    block_six_side = ImageTk.PhotoImage(Image.open("dice6.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_five_side = ImageTk.PhotoImage(Image.open("dice5.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_four_side = ImageTk.PhotoImage(Image.open("dice4.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_three_side = ImageTk.PhotoImage(Image.open("dice3.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_two_side = ImageTk.PhotoImage(Image.open("dice2.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_one_side = ImageTk.PhotoImage(Image.open("dice1.jpeg").resize((33, 33), Image.ANTIALIAS))
